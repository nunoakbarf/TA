...
class DataProduk extends CI_Controller{
	...
	function index(){
		...
		$this->db->or_like('vend_id', $data['keyword']);
		$this->db->or_like('quantity', $data['keyword']);
		$this->db->or_like('hargabeli', $data['keyword']);
		$this->db->or_like('prod_price', $data['keyword']);
		$this->db->or_like('cat_name', $data['keyword']);
