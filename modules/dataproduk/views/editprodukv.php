                    ...
                    <?php foreach ($edit as $p) : ?>
                        <form class="user" method="POST" action="<?= base_url('dataproduk/update'); ?>" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="vend_id" class="form-control form-control-user" placeholder="Nama Produk" value="<?= $p['vend_id']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="hargabeli" class="form-control form-control-user" placeholder="Nama Produk" value="<?= $p['hargabeli']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Harga Produk</label>
                                <div class="col-sm-3">
                                    <input type="text" name="prod_price" class="form-control form-control-user" placeholder="Nama Produk" value="<?= $p['prod_price']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Stok</label>
                                <div class="col-sm-3">
                                    <input type="text" name="quantity" class="form-control form-control-user" placeholder="Nama Produk" value="<?= $p['quantity']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
